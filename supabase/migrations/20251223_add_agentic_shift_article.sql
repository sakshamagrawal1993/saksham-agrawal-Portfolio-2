...
-- Insert the Agentic Shift article
INSERT INTO public.journal_articles (title, date, excerpt, image, content)
VALUES (
  'The Agentic Shift: A Comprehensive Framework for AI Product Life Cycle Management',
  'December 2025',
  'The discipline of Product Life Cycle Management (PLM) is currently undergoing its most significant transformation since the advent of Agile methodology.',
  '/journal/ai-lifecycle.png',
