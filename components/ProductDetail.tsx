        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          <div className="lg:col-span-5 flex flex-col lg:sticky lg:top-32 h-fit">
             ...
             <div className="flex gap-4 mb-8">
                {project.demoUrl && (
                    <a href={project.demoUrl} className="flex-1 py-4 bg-[#2C2A26] text-[#F5F2EB] text-center uppercase tracking-widest text-sm font-medium hover:bg-[#433E38] transition-colors">
                        Live Demo
                    </a>
                )}
                {project.repoUrl && (
