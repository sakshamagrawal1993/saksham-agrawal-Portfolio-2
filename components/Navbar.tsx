      ...
      >
        <div className="max-w-[1800px] mx-auto px-8 flex items-center justify-between">
          ...
          <a
            ...
            className={`text-2xl font-serif font-bold tracking-tight z-50 relative transition-colors duration-500 ${logoColorClass} flex items-center gap-2`}
          >
            <BrandIcon className="w-10 h-10" isDark={scrolled || mobileMenuOpen} />
            {BRAND_NAME}
          </a>
